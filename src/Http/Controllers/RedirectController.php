<?php
/*
 *  mollie_interface - RedirectController.php Copyright (c) 2023 PTMDevelopment -  Jonathan. All rights reserved.
...
namespace PTM\MollieInterface\Http\Controllers;
...
{
    public function subscribable(Request$request){

<?php
/*
 *  mollie_interface - FirstPaymentPaid.php Copyright (c) 2023 PTMDevelopment -  Jonathan. All rights reserved.
...
class FirstPaymentPaid
{
    ...
    public function __construct(Payment $payment, \PTM\MollieInterface\models\Payment $record)
    {
